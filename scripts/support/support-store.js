...
import {
  MODULE_ID, SETTINGS, HOOKS, SUPPORT_ABILITY_KINDS, SUPPORT_BURN_KINDS,
...
export class SupportStore {
  ...
  static _passiveFlag(supportId) { return { [MODULE_ID]: { supportPassive: true, supportId } }; }
  ...
  static registerHandlers() {
    Hooks.on("createChatMessage", (message) => {
      const flag = message?.flags?.[MODULE_ID]?.supportAction;
